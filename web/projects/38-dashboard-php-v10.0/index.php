...
?>
<?php if(isset($_GET['loggout'])) \Painel::loggout(0);?>
<!DOCTYPE html>
<html lang="pt-br">
	<head>	
		<meta charset="utf-8" />
		...
		<?php \Painel::loadCSS(array('login'),array('login'),0,1);?>
		<?php \Painel::loadCSS(array('noticias'),array('noticias'),0,1);?>
		<?php \Painel::loadCSS(array('imoveis'),array('imoveis'),0,1);?>
		<?php \Painel::loadCSS(array('contato'),array('contato'),0,1);?>
	...
	<body>
				...
				<nav class="desktop right">
					<ul>
						...
						<?php
							if(\Painel::logged(0)){
						?>
							<li><a title="Loggout" href="<?php path();?>?loggout"><i class="fas fa-sign-out-alt"></i> <span>Exit</span></a><li>
						<?php }else{ ?>
							<li><a title="Login" href="<?php path();?>login"><i class="fas fa-sign-in-alt"></i> <span>Login</span></a></li>
						<?php } ?>
		...
		<?php \Painel::loadJS(array('jquery.maskmoney','jquery.ajaxform'),array('imoveis','noticias'),1,1);?>
		<?php \Painel::loadJS(array('imoveis'),array('imoveis'),0,1);?>
		<?php \Painel::loadJS(array('map'),array('contato'),0,0);?>
		<?php \Painel::loadJS(array('notices'),array('noticias'),0,0);?>
