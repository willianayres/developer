<?php
	...
	$per_page = PER_PAGE;
	$notices  = Painel::getData('tb_site.notices','*',' ORDER BY order_id ASC LIMIT '.($cur_page - 1) * $per_page.','.$per_page,array(),true,true);
?>
<div class="box">
	...
	<div class="pagination">
		<?php
			...
			$tot_pages = ceil(count(Painel::getData('tb_site.notices','*','',array(),true,true)) / $per_page);
