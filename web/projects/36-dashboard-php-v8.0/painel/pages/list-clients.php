...
<div class="box">
	...
	<div class="boxes">
		<?php
			$clients = \Painel::getData('tb_admin.clients','*',$query,[],1,1);
			$clients_search = \Painel::getData('tb_admin.clients','*',$query_search,[],1,1);
	...
	<div class="pagination">
		<?php
			...
			$tot_pages = ceil(count(\Painel::getData('tb_admin.clients', '*',$query_search,[],1,1)) / $per_page);
