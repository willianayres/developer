<?php
	if(isset($_GET['delete'])){
		...
		$notices = \Painel::getData('tb_site.notices','*',' WHERE category_id = ?',array($id_del),1,1);
	...
	$per_page = PER_PAGE;
	$categories = \Painel::getData('tb_site.categories','*',' ORDER BY order_id ASC LIMIT '.($cur_page - 1) * $per_page.','.$per_page,[],1,1);
?>
<div class="box">
	...
	<div class="pagination">
		<?php
			...
			$tot_pages = ceil(count(\Painel::getData('tb_site.categories','*','',[],1,1)) / $per_page);
