<?php
	...
	$per_page = PER_PAGE;
	$services = \Painel::getData('tb_site.services','*',' ORDER BY order_id ASC LIMIT '.($cur_page - 1) * $per_page.','.$per_page,[],1,1);
?>
<div class="box">
	...
	<div class="pagination">
		<?php
			...
			$tot_pages = ceil(count(Painel::getData('tb_site.services','*','',[],1,1)) / $per_page);
