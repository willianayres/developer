...
<html lang="pt-br">
	<head>
		...
		<?php Painel::loadCSS(array('https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;700&display=swap'),'',true,true,true);?>
		<?php Painel::loadCSS(array('fontawesome','default','box'),'',true,true);?>
		<?php Painel::loadCSS(array('home'),array('','home'));?>
		<?php Painel::loadCSS(array('boxes','search'),array('list-clients','list-products','edit-product','list-enterprises','edit-enterprise','edit-building'));?>
		<?php Painel::loadCSS(array('pagination'),array('edit-client','edit-product','list-categories','list-clients','list-notices','list-products','list-services','list-slides','list-testimonies','payments','list-enterprises','edit-building'));?>
		<?php Painel::loadCSS(array('pdf'),array('payments'));?>
		<?php Painel::loadCSS(array('zebra-datepicker'),array('edit-client'));?>
		<?php Painel::loadCSS(array('jquery-ui.min'),array('list-enterprises'));?>
