<section class="one-banner">
	<?php
		$slides = Painel::getData('tb_site.slides', '*', "ORDER BY order_id ASC LIMIT 0,3", array(), true, true);
...
<section class="four-extras">
	...
	<div class="center">
		<div class="a1 width-50 left">
			...
			<?php
				$testimonies = Painel::getData('tb_site.testimonies', '*', "ORDER BY order_id ASC LIMIT 0,3", array(), true, true);
		...
		<div class="a2 width-50 left">
			...
			<div id="servicos" class="services">
				<ul>
					<?php
						$services = Painel::getData('tb_site.services', '*', "ORDER BY order_id ASC LIMIT 0,3", array(), true, true);
