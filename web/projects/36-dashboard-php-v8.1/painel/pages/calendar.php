<?php 
	...
	$prev_month_date = "$prev_year-$prev_month-01";
	...
	if(strtotime($prev_month_date) < strtotime(MAX_TIME[0]) || strtotime($next_month_date) > strtotime(MAX_TIME[1])){
		\Painel::alert('error','Você está tentando acessar uma data inválida!');
		die();
	}
