<?php
	...
	$all = \Painel::getData('tb_admin.visits','*','',[],0,0);
	$all = $all->rowCount();
	$today = \Painel::getData('tb_admin.visits','*',' WHERE day = ?',array(date('Y-m-d')),0,0);
...
<div class="box w100 left">
	...
	<div class="table">
		...
		<?php
			$usersPainel = \Painel::getData('tb_admin.users','*','',[],1,1);
