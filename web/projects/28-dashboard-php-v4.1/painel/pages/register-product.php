<div class="box">
	...
	<h2><i class="fas fa-edit"></i></i> Cadastrar Produtos</h2>
	<form method="post" enctype="multipart/form-data">
		<?php
			...
			if(isset($_POST['action'])){
				...
				if($name == '' || $description == '' || $width == '' || $height == '' || $lenght == '' || $weight == ''){
					$check = false;
				...
				if($check){
					...
					$product = array('table'=>'tb_admin.storage','name'=>$name,'description'=>$description,'width'=>$width,'height'=>$height,'lenght'=>$lenght,'weight'=>$weight,'amount'=>$amount);
		...
		<div class="group">
			...
			<input type="number" name="lenght" min="0" max="900" step="5" value="0" required />
		</div><!--group-->
		...
		<div class="group">
			...
			<input type="submit" name="action" value="Cadastrar Produto" />
		</div><!--group-->
	</form>
