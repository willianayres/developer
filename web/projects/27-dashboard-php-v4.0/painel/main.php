...
<html lang="pt-br">
	<head>
		...
		<?php Painel::loadCSS(array('zebra-datepicker.css'),'edit-client');?>
	...
	<body>
		...
		<?php Painel::loadJS(array('ajax.js','jquery.ajaxform.js'),'list-clients');?>
		<?php Painel::loadJS(array('ajax.js','helpermask.js','jquery.ajaxform.js','payments.js','jquery.maskmoney.js','zebra.datepicker.js'),'edit-client');?>
